...
<div class="wrapper">
 ...
 <svg xmlns="http://www.w3.org/2000/svg" onclick="parent.location='perfil.php'" width="20" height="20" fill="currentColor" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
  ...
  <svg viewBox="0 0 512 512" fill="currentColor" class="active" onclick="parent.location='mensagem.php'">
 ...
 <div class="main-container">
  ...
  $sql = 'SELECT * FROM notificacao';//buscar tudo na tabela trabalho
      ...
      <tbody>
       <tr onclick="window.open('submeter.html','pagename','resizable,height=570,width=700'); <!--onclick=" document.location="perfil.php" ;="">
        <td>
         ...
         <span style="padding-left: 35px;"><?php echo $trblh_asunto[$iol]; ?>   </span>
        </td>
