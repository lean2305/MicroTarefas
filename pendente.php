...
<div class="wrapper">
 ...
 <div class="main-container">
  <div class="header">
   ...
   <a class="header-link " href="principal.php"><svg viewBox="-6 0 512 512" fill="currentColor">
   ...
   <a class="header-link active"  href="historico.php"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    ...
    <div class="cards card">
     ...
     <table class="table">
      <thead>
       <tr>
        <th>Prova</th>
        <th style=" padding-left: 30px;">Empregador</th>
        <th style=" padding-left: 30px;">Trabalhador</th>
        <th style=" padding-left: 30px;">Id</th>
        <th style=" padding-left: 30px;">Valor</th>
  ...
  $sql = "SELECT * FROM provas where trabalhador='$logado' ";//buscar tudo na tabela provas
  ...
  while($reg=mysqli_fetch_assoc($res)){
    ...
    $trabalhador[$iol] = $reg['trabalhador'] ; 
      
    $prova[$iol] = $reg['provas'] ; 
  ...
  ?>
      ...
      <tbody>
       <tr onclick="window.open('submeter.html','pagename','resizable,height=570,width=700'); <!--onclick=" document.location="perfil.php" ;="">
        ...
        <td ><strong><?php echo $empregador[$iol]; ?></strong></td>
        <td style=" padding-left: 30px;"><?php echo $trabalhador[$iol]; ?></td>
   ...
   <div class="card transection" style="--delay: 1.2s">
    ...
    <form  method="POST" action="report.php" >
            ...
            <div class="form" style=" padding-left: 22px;">
                ...
                <textarea  style="border-radius: 7px;color: white;background-color: #1a2049;border: 3px solid #1a2049;"  maxlength="350"  id="w3review" name="w3review" rows="13" cols="25" placeholder="Justificação"></textarea><br>
