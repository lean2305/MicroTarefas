...
//Obter id_trabalho da tabela trabalho
 ...
 <div class="main-container">
  ...
  <div class="user-box second-box">
   <div class="cards-wrapper" style="--delay: 1s">
    ...
    <?php
    $sql = "SELECT * FROM provas WHERE id_prova = '$id' ";
  ...
  while($reg=mysqli_fetch_assoc($res)){
    $id_prova[$iol] = $reg['id_prova'] ;  //buscar dados na tabela trabalho coluna assunto
    $empregador[$iol] = $reg['empregador'] ;  //buscar dados na tabela trabalho coluna valor
    $provas[$iol] = $reg['provas'] ;  //buscar nome da pessoa que inseriu o trabalho
    $trabalhador[$iol] = $reg['trabalhador'] ;  //buscar descrição da pessoa que inseriu o trabalho
    $valor[$iol] = $reg['valor']; // buscar o id do trabalho
