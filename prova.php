 ...
 <div class="main-container">
  ...
  <div class="user-box second-box">
   ...
   <div class="cards-header">
     ...
     Tarefas disponiveis<p style="padding-left:250px">&nbsp;</p>
     </div>
    ...
    <!-- div sem conteudo--->
     ...
     <a style="text-decoration:none;color:white" href="inserir.html"> Criar nova tarefa</a>
     </div>
    </div>
    ...
    if($res=mysqli_query($conn,$sql)){
      ...
      $trblh_empregador = array();
      $trblh_provas = array();
      $trblh_trabalhador = array();
      $trblh_valor = array();
      $iol = 0;
    ...
    while($reg=mysqli_fetch_assoc($res)){     
      ...
      $trblh_trabalhador[$iol] = $reg['trabalhador'] ;  //buscar nome da pessoa que inseriu o trabalho
      ...
      //echo "<a href='pagar.php?id=" . $row_utilizador['id_prova'] . "'>Pagar</a><br>";
		...
		$result_pg = "SELECT COUNT(id_prova) AS num_result FROM provas";
		...
		//echo "<a href='perfil.php?pagina=$quantidade_pg'>&nbsp;</a>";
		
		?>	

<td><strong><?php echo  $trblh_provas[$iol] . "<br>";  ?></strong></td>
       <td>
         
         <span><?php echo  $trblh_empregador[$iol] . "<br>"; ?></span>
        </td>
 
        <td><?php echo  $trblh_trabalhador[$iol] . "<br>"; ?></td>
        <td><?php echo  $trblh_valor[$iol]  . "<br>"; ?></td>
        ...
        <td>
         <div class="status is-green">
          ...
          <?php echo "<a class='cards-button button' href='verprova.php?id=" . $reg['id_prova'] . "'>Abrir</a><br>"; ?>
          ...
          <?php  $iol =$iol +1;//adicionar +1 na variavel iol    ?>
          <?php  }}    ?>
