...
$sql= "SELECT * FROM utilizador where utilizador = '$empregador' ";//buscar tudo na tabela utilizador onde for igual a sessão da pessoa
if($ress=mysqli_query($conn,$sql)){
    ...
    while($regg=mysqli_fetch_assoc($ress)){
        ...
        $avaliacao[$ioll] = $regg['avaliacao'] ;  //buscar dados na utilizador  coluna saldo
