...
<div class="wrapper">
 ...
 <div class="main-container">
  <div class="header">
   ...
   <a class="header-link" href="#"><svg viewBox="-6 0 512 512" fill="currentColor">
   ...
   <div class="discount card" style="--delay: .4s">
    ...
    <div class="discount-wrapper">
     <div class="discount-info">
      ...
      $query= "SELECT id_prova from provas where empregador = '$logado'";
    ...
    <div class="cards card">
     <div class="cards-head">
      <div class="cards-info">
       ...
       <div class="account-cash"><?php   echo $valor_saldo[$ioll] = $regg['saldo']; ?>€ </div>
...
<?php   }     ?>
     ...
     <div class="account-name"> <?php echo $logado; ?></div>
   ...
   <div class="discount card" style="--delay: .4s; ">
    ...
    <div class="discount-wrapper">
     <div class="discount-info">
      ...
      $query= "SELECT id_prova from provas where trabalhador = '$logado' ";
      $query_run = mysqli_query($conn,$query);
