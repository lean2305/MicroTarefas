 ...
 <div class="main-container">
  ...
  <div class="user-box second-box">
   <div class="cards-wrapper" style="--delay: 1s">
    ...
    <?php
    $sql = "SELECT * FROM trabalho WHERE id_trabalho = '$id' ";
...
$sql  ="SELECT * from arquivo where utilizador = 'leandro' ";
...
<div class="utilizador" style=" padding-left: 22px;">
    ...
    <input type="hidden" id="assunto" name="assunto" value="<?php echo $trblh_user[$iol];  ?>">
    <textarea  style="border-radius: 7px;color: white;background-color: #1a2049;border: 3px solid #1a2049;    width: 100%;"  maxlength="350"  id="w3review" name="w3review" rows="8"  placeholder="Insira a prova" ></textarea><br>
