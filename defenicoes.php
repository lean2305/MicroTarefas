...
<head>
  ...
  <link rel="stylesheet" href="css/novapassword.css">  
...
<div class="wrapper">
 <div class="left-side">
 <svg xmlns="http://www.w3.org/2000/svg" onclick="parent.location='perfil.php'" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
  ...
  <svg viewBox="0 0 512 512" fill="currentColor" class="active" onclick="parent.location='defenicoes.php'" >
...
<div class="button-wrapper">
  ...
  <br>  <br> 
    ...
    <input  class="button offer-button" type="submit" value="Enviar"  > 
</div>
...
<div class="button-wrapper">
  ...
  <br>  <br> 
  <div class="login-box">
  <h2>Trocar password</h2>
  <form  method="post" action="novapassword.php">
    <div class="user-box">
    <input type="password" name="atual" placeholder="" required="required">
      <label>Password atual</label>
    </div>
    <div class="user-box" style="padding-bottom:20px">
      
      <input type="password" name="nova" placeholder="" required="required">
      <label>Nova password</label>
      
    </div>
    <button style="border-radius: 7px;color: white;background-color: #1a2049;border: 3px solid #1a2049;" type="submit" class="btn btn-primary btn-block btn-large">Salvar</button>
  </form>
